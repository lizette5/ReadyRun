...
public class RegisterAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.txtAvg2 = convertView.findViewById(R.id.txt_item_avg2);
        ...
        if (dataMap.get(arrayKey[position]).getAverage() != null){
            ...
            kilometroxh = Double.parseDouble(dataMap.get(arrayKey[position]).getAverage());
            calorias = 0.0175* kilometroxh*50;
            cal= String.valueOf(String.format("%.3f", calorias));
            holder.txtAvg2.setText(String.format("%s cal",cal));
        }
