...
public class ConfigurationFragment extends Fragment implements
    ...
    private ArrayList<String> modes = new ArrayList<>(Arrays.asList(Utils.MODES.CAMINATA.toString(), Utils.MODES.CICLISMO.toString(), Utils.MODES.CARRERAS.toString()));
    private String[] modesString = {Utils.MODES.CAMINATA.toString(), Utils.MODES.CICLISMO.toString(), Utils.MODES.CARRERAS.toString()};
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        btn_music =rootView.findViewById(R.id.buttonMusic);

        context = getContext();

        btn_music.setOnClickListener(view -> {
